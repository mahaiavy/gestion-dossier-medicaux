...
const General=({admission_id,ide,soin})=>{
...
const handleRaioChange=(event)=>{
  ...
  let ligne=count.map(counte=>{
    ...
    <HeureTraitement name={counte.id} onChange={handleRaioChange}/>
        ...
        return(
            ...
            <HeureTraitement name={counte.id} onChange={handleRaioChange}/>
              ...
              <span className="p-1 fa fa-trash text-danger" onClick={()=>suprimerElement(counte.id)} type="button"></span>
            </td >
    ...
    const onSubmit= async (data)=>{
        ...
        if(data.autre_periodique!=null){

            contextAuthValue.socket.emit("newSoin",data);
            // contextPatientValue.createSoin(data);
            // const res= await axios.post("http://169.254.218.64:8000/pediatrie/consultation/add",data);
        }
    ...
    return(
        <div className={soin ? " tab-pane fade " : "tab-pane fade show active"} id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
                                ...
                                <div className="card-body ">
                                    ...
                                    <div className="rounded-lg ">
                                        <div className="p-2 text-sm font-bold text-gray-800 row">
                                            ...
                                            <input type="text" className="form-control input" {...register('pc')}  placeholder="Ex:5/8"/>
